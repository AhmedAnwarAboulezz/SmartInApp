...
@Component({
  selector: 'app-list-manager-return-leaves',
  templateUrl: './list-manager-return-leaves.component.html',
  styleUrls: ['./list-manager-return-leaves.component.scss'],
})
export class ListManagerReturnLeavesComponent implements OnInit {
