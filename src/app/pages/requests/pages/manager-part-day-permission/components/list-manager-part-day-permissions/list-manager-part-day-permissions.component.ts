...
@Component({
  selector: 'app-list-manager-part-day-permissions',
  templateUrl: './list-manager-part-day-permissions.component.html',
  styleUrls: ['./list-manager-part-day-permissions.component.scss'],
})
export class ListManagerPartDayPermissionsComponent implements OnInit {
