...
@Component({
  selector: 'app-manager-part-day-list-item',
  templateUrl: './manager-part-day-list-item.component.html',
  styleUrls: ['./manager-part-day-list-item.component.scss'],
})
export class ManagerPartDayListItemComponent implements OnInit {
