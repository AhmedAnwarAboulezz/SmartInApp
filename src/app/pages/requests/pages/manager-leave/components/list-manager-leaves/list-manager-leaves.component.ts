...
@Component({
  selector: 'app-list-manager-leaves',
  templateUrl: './list-manager-leaves.component.html',
  styleUrls: ['./list-manager-leaves.component.scss'],
})
export class ListManagerLeavesComponent implements OnInit {
