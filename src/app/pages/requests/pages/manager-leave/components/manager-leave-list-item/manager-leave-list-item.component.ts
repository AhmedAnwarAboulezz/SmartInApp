...
@Component({
  selector: 'app-manager-leave-list-item',
  templateUrl: './manager-leave-list-item.component.html',
  styleUrls: ['./manager-leave-list-item.component.scss'],
})
export class ManagerLeaveListItemComponent implements OnInit {
