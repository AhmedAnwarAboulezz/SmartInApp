...
@Component({
  selector: 'app-list-manager-over-times',
  templateUrl: './list-manager-over-times.component.html',
  styleUrls: ['./list-manager-over-times.component.scss'],
})
export class ListManagerOverTimesComponent implements OnInit {
