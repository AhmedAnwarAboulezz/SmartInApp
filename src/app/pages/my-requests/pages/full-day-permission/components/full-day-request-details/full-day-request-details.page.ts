...
@Component({
  selector: 'app-full-day-request-details',
  templateUrl: './full-day-request-details.page.html',
  styleUrls: ['./full-day-request-details.page.scss'],
})
export class FullDayRequestDetailsPage implements OnInit, OnDestroy {
  id: any;
  model: any = {};
  segmentValue = true;
  @Input() selected: any = {};
  ...
  getDocument(fileName : string){
   ...
   this.service.downloadfile(fileName, "fullDayPermission") 
   .subscribe(response => {
